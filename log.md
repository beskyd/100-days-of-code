...
**Today's progress**: Code School's Flexbox course levels 3 and 4. Wes Bos's Flexbox course.
...
**Today's progress** : Lesson 24 of JavaScript30.
**Note** : You cannot 'transition' with css the 'width' property from 0 to 'auto'. You have to use 'max-width' for this.
